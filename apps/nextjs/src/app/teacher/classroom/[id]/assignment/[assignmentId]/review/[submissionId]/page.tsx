    ...
    return (
      <div className="container mx-auto max-w-3xl p-6">
        <Card>
          ...
          <CardContent>
            <Button asChild>
              <Link href={`/teacher/classroom/${classroomId}/assignment/${assignmentId}`}>
                Back to Assignment
              </Link>
            </Button>
          </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              {submission.workspaceId ? (
                <TextReplayScrubberComponent workspaceId={submission.workspaceId} />
              ) : (
                <p className="text-sm text-muted-foreground">
                  No workspace is attached to this submission, so replay is unavailable.
                </p>
              )}
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              <p className="text-xs text-muted-foreground">
                Feedback and grade are saved independently, so you can update either field at
                any time.
              </p>
            </CardContent>
          </Card>
        ...
        <div className="container mx-auto max-w-xl p-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Sign in to review this submission.</CardDescription>
            </CardHeader>
            <CardContent>
              <Button asChild>
