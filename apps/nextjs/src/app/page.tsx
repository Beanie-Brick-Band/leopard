        ...
        <div className="grid w-full items-center gap-16 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.15fr)] lg:gap-20">
          <section className="max-w-[520px]">
            <div className="mb-12 flex items-center gap-5">
              <div className="flex h-[60px] w-[60px] items-center justify-center rounded-[18px] bg-[#a8d3e3] text-[2rem] font-bold text-white shadow-[0_12px_30px_rgba(168,211,227,0.3)]">
                L
              </div>
              <div className="text-[2rem] font-semibold tracking-[-0.04em] text-[#202125]">
                Leopard
              </div>
            </div>

            <h1 className="max-w-[440px] text-[3.35rem] leading-[0.97] font-semibold tracking-[-0.07em] text-[#17171b] sm:text-[4.5rem]">
              The IDE built for education
            </h1>

            <p className="mt-8 max-w-[470px] text-[1.08rem] leading-[1.65] text-[#5a5d63] sm:text-[1.2rem] sm:leading-[1.6] lg:text-[1.08rem]">
            ...
            <div className="mt-10 space-y-4">
              {featureItems.map(({ icon: Icon, label }) => (
                <div key={label} className="flex items-center gap-5">
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#e5f2f7] text-[#23799b]">
                    <Icon className="h-7 w-7 stroke-[1.8]" />
                  </div>
                  <span className="text-[1.05rem] tracking-[-0.02em] text-[#4a4d54] sm:text-[1.15rem]">
                    {label}
                  </span>
                </div>
              ))}
          ...
          <section className="flex justify-center lg:justify-end">
            <div className="w-full max-w-[780px] rounded-[28px] bg-[#292827] text-[#d4d4d4] shadow-[0_38px_90px_rgba(42,36,30,0.24)]">
              <div className="flex items-center gap-4 rounded-t-[28px] border-b border-white/10 px-5 py-4 sm:px-6">
