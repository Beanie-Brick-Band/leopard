...
function AuthenticatedRedirect() {
  ...
  useEffect(() => {
    ...
    // If profile is undefined, we're still loading
  }, [profile, router]);
    ...
    return (
      <div className="flex min-h-screen items-center justify-center">
        <div className="text-center">
          <div className="mb-4 text-lg">Setting up your account...</div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      <div className="text-center">
        <div className="mb-4 text-lg">Redirecting to dashboard...</div>
      </div>
    </div>
  );
}
...
export default function HomePage() {
  return (
    <main>
      <Unauthenticated>
        <div className="relative min-h-screen overflow-x-hidden overflow-y-auto overscroll-contain bg-zinc-950 text-white">
              ...
              <div className="flex flex-col gap-3 sm:gap-4 lg:pl-12">
                <div className="flex items-center gap-3 sm:gap-6">
                  ...
                  >
                    ...
                    <path
                      fill="#a37e3d"
                      d="m12.2 24.3l-1.8 1.8l1.8 1.9l1.8-1.9z"
                    />
                    <path
                      fill="#3e4347"
                ...
                <p className="max-w-xl text-sm leading-relaxed text-zinc-300 sm:text-base">
                  A web-based platform designed for post-secondary institutions
                  to ensure academic integrity in coding assignments. Leopard
                  provides students with a modern IDE while capturing granular
                  version history to verify the authenticity of their work.
                </p>

                <div className="flex gap-3">
                  <Link
                    href="/auth/sign-in"
                    className="bg-foreground text-background hover:bg-foreground/90 w-fit rounded-sm px-8 py-2 transition-colors"
                  >
                    Sign In
                  </Link>
                  <Link
                    href="/auth/signup"
                    className="hover:bg-foreground/10 w-fit rounded-sm border border-white/30 px-8 py-2 transition-colors"
                  >
                    Sign Up
                  </Link>
                </div>
              ...
              <div className="flex flex-col gap-4 sm:gap-6 lg:pr-12">
                <div className="transform rounded-xl border border-amber-900/30 bg-gradient-to-br from-zinc-900 to-zinc-900/50 p-5 transition-all duration-300 hover:-translate-y-1 hover:border-amber-600/50 hover:shadow-2xl hover:shadow-amber-900/20 sm:rounded-2xl sm:p-8">
                  ...
                  <p className="text-sm text-zinc-400 sm:text-base">
                    Complete assignments in a familiar code environment with
                    syntax highlighting, code execution, and real-time feedback.
                  </p>
                </div>
