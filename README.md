...
> In this template, we use `@package` as a placeholder for package names. As a user, you might want to replace it with your own organization or project name. You can use find-and-replace to change all the instances of `@package` to something like `@my-company` or `@project-name`.
...
3. Outputs a Drizzle-compatible schema file to the `@package/db` package
